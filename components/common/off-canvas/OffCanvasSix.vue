          ...
          <div class="mean-bar">
            ...
            <nav>
              <ul>
                ...
                <li>
                  <nuxt-link to="/admin/booking" @click="closeOffcanvas"
                    >- รายการจอง</nuxt-link
                  >
                </li>
                <hr />
                <li class="text-secondary">งานจัดการเครื่องมือ</li>
                <li>
                  <nuxt-link to="/admin/equipment" @click="closeOffcanvas"
                ...
                <li>
                  <nuxt-link href="/admin/banner" @click="closeOffcanvas"
                    >- จัดการ Banner</nuxt-link
                  >
                </li>
                <li>
                  <nuxt-link href="/admin/news" @click="closeOffcanvas"
                    >- จัดการข่าว</nuxt-link
                  >
                </li>
                <li>
                  <nuxt-link href="/admin/news-type" @click="closeOffcanvas"
                ...
                <li>
                  <nuxt-link href="/admin/department" @click="closeOffcanvas"
                    >- ฝ่ายงาน</nuxt-link
                  >
                </li>
                <li>
                  <nuxt-link href="/admin/contact-us/1" @click="closeOffcanvas"
