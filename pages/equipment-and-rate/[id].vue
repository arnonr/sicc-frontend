                ...
                <div class="col-xxl-12" v-if="item != null">
                    <div class="breadcrumb__content p-relative z-index-1">
                        ...
                        <div class="breadcrumb__list">
                            ...
                            ></span>
                            <span class="breadcrumb-item-1">
                                <NuxtLink href="/sample-submission">
                                ...
                                <div class="col-lg-12">
                                    <div class="postbox__main-wrapper">
                                        ...
                                        <div
                                            ...
                                            v-if="
                                                item.equipment_department_id ==
                                                1
                                            "
                                        >
                                            <div
                                                class="div-btn-sample-submission"
                                            >
                                                <div class="col">
                                                    <div
                                                        class="tp-button-demo text-center"
                                                    >
                                                        <NuxtLink
                                                            :to="{
                                        ...
                                        <!-- ติดต่อกรณีไม่ใช้่ SITT -->
                                        <div
                                            class="pl-10 pt-15 pb-10 bg-grey"
                                            v-if="
                                                item.equipment_department_id !=
                                                1
                                            "
                                        ...
                                        >
                                            <div
                                                v-html="
                                                    item.equipment_department.contact_us_th == null
                                                        ? ''
                                                        : item.equipment_department.contact_us_th
                                                "
                                            ></div>
                                        </div>
                                    </div>
