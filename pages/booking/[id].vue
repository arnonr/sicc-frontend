              ...
              <div class="row">
                <div class="col-lg-12">
                  <div
                    ...
                    v-if="booking.status_id != 2 && booking.status_id != 4"
                  >
                          ...
                          <div v-if="checkSummary == true">
                            <div class="card" style="border: none">
                              <div class="card-body row">
                                ...
                                <div class="col-lg-6 mt-10">
                                  <span class="fw-bold text-dark"
                                    >เวลาที่จอง/Booking Time : </span
                                  ><span class="text-color-primary fw-bold">{{
                                    useCookie("lang").value == "en"
                                      ? booking.period_time.name_en
                                      : booking.period_time.name_th
                                  }}</span>
                                  <hr class="hr-dotted" />
                                </div>
                                ...
                                <div class="col-lg-12 mt-10">
                                  ...
                                  <div
                                    class="row"
                                    v-if="
                                      booking.status_id > 4 && preview_slip_file
                                    "
                                  >
                                    <div class="col-lg-12 mt-10">
                                      <span class="fw-bold text-dark"
                  ...
                  <div v-else>
                    ...
                    <h4 class="mt-40 mb-10">
                      กรุณาโอนเงินเพื่อเข้าชำระค่าบริการ/ทดสอบของศูนย์ SITT
                    </h4>
                    <div class="p-2 row">
                      <div
                        class="col-md-6 p-3"
                      ...
                      <div class="col-md-12 mt-40">
                        <span class="text-danger fs-5">
                          *** ใบเสร็จรับเงินที่ได้รับ
                          จะลงวันที่ตรงกับหลักฐานการโอนเท่านั้น ***
                        </span>
                        <br>
                        <span class="text-danger fs-5"
                          >***
                          สำหรับการชำระเงินเพิ่มเติมในวันที่มาวิเคราะห์จะถูกออกใบเสร็จรับเงินเพิ่มเติม
                          ณ วันนั้น ซึ่งจะแยกกับกับใบเสร็จรับเงินที่ชำระมาช่วงจองใช้บริการเครื่องมือ
                          ***
                        </span>

                        <!-- <img
                                                    src="~/assets/img/logo/PromptPay-logo.png"
                                                    class="w-25 mb-0 pb-0"
                                                /><br />
                                                <img
