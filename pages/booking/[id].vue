                                  ...
                                  <hr class="hr-dotted" />
                                    ...
                                    <div v-else>
                                        ...
                                        <h4 class="mt-40 mb-10">
                                            กรุณาโอนเงินเพื่อเข้าชำระค่าบริการ/ทดสอบของศูนย์
                                            SITT
                                        </h4>
                                        <div class="p-2 row">
                                            <div
                                            ...
                                            >
                                                <img
                                                    src="~/assets/img/logo/logo-kt.jpeg"
                                                />
                                            </div>
                                            <div
                                        ...
                                        <div class="form row">
                                            ...
                                            <div
                                                class="form-group row col-md-12 mt-20"
                                            >
                                                <label
                                                    for="staticEmail"
                                                    class="col-sm-12 col-form-label"
