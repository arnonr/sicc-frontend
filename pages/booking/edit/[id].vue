                                ...
                                <div class="card-body">
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                      ...
                                      <div class="mt-6 fs-6 text-danger">
                                        *** ปิดให้บริการทุกวัน เสาร์ – อาทิตย์
                                        และวันหยุดนักขัตฤกษ์ ***<br />ก่อนทำการจองสามารถติดต่อสอบถามวันเวลาที่เครื่องว่างได้ที่
                                        02-555-2000 ต่อ 4257,4241
                                      </div>
                                    </div>
                                  </div>
  ...
  await $fetch(`${runtimeConfig.public.apiBase}/booking/check-booking-date`, {
    ...
    .then((res) => {
      if (res.msg == "success") {
        ...
        const check = selectOptions.value.period_times.find((x) => {
          return x.id == booking.value.period_time.id;
        });
