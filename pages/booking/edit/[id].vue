                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="postbox__main-wrapper">
                                        ...
                                        <div
                                            class="postbox__details-content-wrapper mt-20 row"
                                        >
                                            <div
                                    ...
                                    <div class="col-sm-8">
                                      ...
                                      <hr class="hr-dotted" />
                                                            ...
                                                            <div v-else>
                                                                <h2
                                                                    class="text-center mt-50 text-danger"
                                                                >
                                                                    {{
                                                                        text_summary_error
                                                                    }}
...
const onCheckBookingDate = async () => {
    ...
    await $fetch(`${runtimeConfig.public.apiBase}/booking/check-booking-date`, {
        ...
        params: {
            ...
            booking_date: dayjs(booking.value.booking_date).format(
                "YYYY-MM-DD"
            ),
        },
    })
        ...
        booking.value.equipment_method =
            booking.value.equipment_booking_method.map((x) => {
                ...
                if (booking.value.member_status.id == 1) {
                    price1 = equipment_method.member1_price;
                    // percent = 0.3;
                } else if (booking.value.member_status.id == 2) {
                    price1 = equipment_method.member2_price;
                    // percent = 0.5;
                } else if (booking.value.member_status.id == 3) {
                    price1 = equipment_method.member3_price;
                    // percent = 0.6;
                } else if (booking.value.member_status.id == 4) {
                    price1 = equipment_method.member4_price;
                    // percent = 0.8;
                } else {
                    price1 = equipment_method.member5_price;
                    // percent = 1;
                }
...
const nextStep = async (step) => {
    ...
    if (step == 0) {
        if (
            ...
            useToast(
                "โปรดระบุข้อมูลวันที่จอง/Booking Date is Require",
                "error"
            );
