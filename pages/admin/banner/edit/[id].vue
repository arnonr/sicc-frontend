<template>
    ...
    <section class="portfolio__area pt-40 pb-40">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h4>แบบฟอร์มแก้ไขข้อมูล Banner</h4>
                </div>
...
const fetchItem = async () => {
    ...
    item.value.banner_file_old = data.data.banner_file;
...
const onSubmit = async () => {
    ...
    let type_object = {
        ...
        method: "put",
        url: runtimeConfig.public.apiBase + "/banner/" + route.params.id,
    };
